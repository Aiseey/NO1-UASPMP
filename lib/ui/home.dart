...
import 'package:flutterdb2/ui/entryform.dart';
import 'package:flutterdb2/models/contact.dart';
import 'package:flutterdb2/helpers/dbhelpers.dart';
...
class HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Daftar Data-Data'),
      ),
      body: createListView(),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (contact != contact2) addContact(contact);
        },
      ),
    );
  }
